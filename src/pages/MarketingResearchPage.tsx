          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_2px_1fr_2px_1fr] py-4 overflow-visible relative gap-y-10 md:gap-y-0">
            ...
            <div className="flex flex-col pr-0 md:pr-10">
              <div className="flex items-start gap-3 mb-5">
                ...
                <img src={headingQuantitative} alt="Quantitative Research" className="h-auto w-full max-w-[220px] object-contain" />
              </div>
              ...
              <ul className="desktop-breaks text-[15px] text-foreground leading-[1.25] space-y-1">
            ...
            <div className="flex flex-col px-0 md:px-10">
              <div className="flex items-start gap-3 mb-5">
                ...
                <img src={headingQualitative} alt="Qualitative Research" className="h-auto w-full max-w-[220px] object-contain" />
              </div>
              <p className="desktop-breaks text-[15px] text-foreground leading-[1.25] mb-5">
            ...
            <div className="flex flex-col pl-0 md:pl-10">
              <div className="flex items-start gap-3 mb-5">
                ...
                <img src={headingObservational} alt="Observational Research" className="h-auto w-full max-w-[220px] object-contain" />
              </div>
              <p className="desktop-breaks text-[15px] text-foreground leading-[1.25] mb-5">
